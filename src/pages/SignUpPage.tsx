    ...
    <div>
      <div className="h-[100vh] overflow-scroll md:overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex flex-col md:pb-[5000px] items-center justify-center gap-y-8 min-w-[40%] bg-slate-200 py-auto overflow-scroll">
            <img
              className="max-w-[180px] md:max-w-[500px] mx-2 mt-12"
              src="https://us01st-cf.zoom.us/fe-static/fe-signup-login-active/img/banner-step-2.4b72ef61.png"
            />
          </div>
          <div className="min-w-[60%] pb-4 md:pb-[5000px] flex flex-col justify-center items-center gap-y-6 mt-12 md:mt-0 overflow-scroll">
            <AddProfilePicture />
